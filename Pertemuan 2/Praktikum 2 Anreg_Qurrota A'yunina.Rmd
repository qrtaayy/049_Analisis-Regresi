...
data <- read_excel("C:\\Users\\USER\\Documents\\Mata Kuliah Semester 4\\Analisis Regresi\\NSC-2025.xlsx", sheet="Sheet2")
...
Didapatkan nilai $\hat\beta_0 = 84.25520$ artinya nilai dugaan rataan indeks pembangunan manusia ketika persentase penduduk miskin bernilai 0 persen adalah 84.2552%, akan tetapi nilai 0 tidak ada dalam selang pengamatan persentase penduduk miskin sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut
...
Koefisien determinasi yang dihasilkan adalah 0.4831 atau 48.31% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase akses sanitasi layak adalah sebesar 48.31%, sisanya yaitu 51.69% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
